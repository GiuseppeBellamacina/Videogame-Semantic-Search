...
Fetches video games released from 2015 onwards with their developers, publishers,
    ...
    for year in range(2015, 2027):
        ...
        for row in bindings:
            ...
            if release_date:
                ...
                g.add((game_uri, VG.releaseDate, Literal(date_str, datatype=XSD.date)))
            ...
            if dev_label:
                ...
                g.add(
                    (dev_uri, VG.developerName, Literal(dev_label, datatype=XSD.string))
                )
            ...
            if pub_label:
                ...
                g.add(
                    (pub_uri, VG.publisherName, Literal(pub_label, datatype=XSD.string))
                )
